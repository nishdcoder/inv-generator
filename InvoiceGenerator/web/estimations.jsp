				...
				<ul id="adminmenu" role="navigation">
					<li class="menu-top active">
						...
						<ul class="admin-submenu admin-submenu-wrap">
							<li>
								<a href="edit.html" class="current">All Estimations</a>
							</li>
							<li>
			...
			<div id="admincontent">
				...
				<div id="adminbody">
					<div id="adminbody-content" aria-label="Main content">
						<div class="wrap">
							<h2>Estimations <a href="edit.html" class="btn-add-new add-new">Create New</a></h2>
							<ul class="subsubsub">
								<li class="all">
									<a href="#" class="current">All <span class="count">(2)</span></a> |
								</li>
								<li class="full-paid">
									<a href="#">Approved <span class="count">(2)</span></a> |
								</li>
								<li class="pending">
